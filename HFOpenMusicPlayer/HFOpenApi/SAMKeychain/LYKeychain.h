...
extern NSString *const kLYKeychainErrorDomain;

/** Account name. */
extern NSString *const kLYKeychainAccountKey;
 ...
 */
extern NSString *const kLYKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kLYKeychainClassKey;

/** Item description. */
extern NSString *const kLYKeychainDescriptionKey;

/** Item label. */
extern NSString *const kLYKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kLYKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kLYKeychainWhereKey;
...
/**
 ...
 LYKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in LYKeychain.h for a list of keys that can be used when accessing the
