...
NS_ASSUME_NONNULL_BEGIN
	...
	#define LYKeyCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define LYKeyCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef LYKeyCHAIN_SYNCHRONIZATION_AVAILABLE
...
#ifdef LYKeyCHAIN_ACCESS_GROUP_AVAILABLE
...
/**
 ...
 LYKeyCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
