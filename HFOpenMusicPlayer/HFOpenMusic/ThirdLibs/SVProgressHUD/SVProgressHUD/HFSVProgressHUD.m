...
#import "HFSVProgressHUD.h"
#import "HFSVIndefiniteAnimatedView.h"
#import "HFSVProgressAnimatedView.h"
#import "HFSVRadialGradientLayer.h"

NSString * const SVProgressHUDDidReceiveTouchEventNotification = @"HFSVProgressHUDDidReceiveTouchEventNotification";
NSString * const SVProgressHUDDidTouchDownInsideNotification = @"HFSVProgressHUDDidTouchDownInsideNotification";
NSString * const SVProgressHUDWillDisappearNotification = @"HFSVProgressHUDWillDisappearNotification";
NSString * const SVProgressHUDDidDisappearNotification = @"HFSVProgressHUDDidDisappearNotification";
NSString * const SVProgressHUDWillAppearNotification = @"HFSVProgressHUDWillAppearNotification";
NSString * const SVProgressHUDDidAppearNotification = @"HFSVProgressHUDDidAppearNotification";

NSString * const SVProgressHUDStatusUserInfoKey = @"HFSVProgressHUDStatusUserInfoKey";
...
@property (nonatomic, strong) HFSVRadialGradientLayer *backgroundRadialGradientLayer;
@property (nonatomic, strong) UIVisualEffectView *hudView;
@property (nonatomic, strong) UILabel *statusLabel;
@property (nonatomic, strong) UIImageView *imageView;

@property (nonatomic, strong) UIView *indefiniteAnimatedView;
@property (nonatomic, strong) HFSVProgressAnimatedView *ringView;
@property (nonatomic, strong) HFSVProgressAnimatedView *backgroundRingView;
...
@implementation HFSVProgressHUD {
    BOOL _isInitializing;
}

+ (HFSVProgressHUD *)sharedView {
    static dispatch_once_t once;
    
    static HFSVProgressHUD *sharedView;
    ...
    dispatch_once(&once, ^{
        ...
        //sharedView = [[self alloc] initWithFrame:[HFVKitUtils getCurrentWindow].bounds];
    });
#else
...
//        _errorImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"error" ofType:@"png"]];
        ...
        _infoImage = KBoundleImageName(@"info");
        _successImage = KBoundleImageName(@"success");
        _errorImage = KBoundleImageName(@"error");
...
- (void)positionHUD:(NSNotification*)notification {
    ...
    //self.frame = [HFVKitUtils getCurrentWindow].bounds;
...
- (void)showProgress:(float)progress status:(NSString*)status {
    __weak HFSVProgressHUD *weakSelf = self;
    [[NSOperationQueue mainQueue] addOperationWithBlock:^{
        __strong HFSVProgressHUD *strongSelf = weakSelf;
        if(strongSelf){
...
- (UIView*)indefiniteAnimatedView {
    ...
    if(self.defaultAnimationType == SVProgressHUDAnimationTypeFlat){
        ...
        if(_indefiniteAnimatedView && ![_indefiniteAnimatedView isKindOfClass:[HFSVIndefiniteAnimatedView class]]){
            [_indefiniteAnimatedView removeFromSuperview];
            _indefiniteAnimatedView = nil;
        }
        
        if(!_indefiniteAnimatedView){
            _indefiniteAnimatedView = [[HFSVIndefiniteAnimatedView alloc] initWithFrame:CGRectZero];
        }
        
        // Update styling
        HFSVIndefiniteAnimatedView *indefiniteAnimatedView = (HFSVIndefiniteAnimatedView*)_indefiniteAnimatedView;
...
- (HFSVProgressAnimatedView*)ringView {
    if(!_ringView) {
        _ringView = [[HFSVProgressAnimatedView alloc] initWithFrame:CGRectZero];
    }
...
- (HFSVProgressAnimatedView*)backgroundRingView {
    if(!_backgroundRingView) {
        _backgroundRingView = [[HFSVProgressAnimatedView alloc] initWithFrame:CGRectZero];
...
- (UIControl*)controlView {
    ...
    //CGRect windowBounds = [HFVKitUtils getCurrentWindow].bounds;
...
-(UIView *)backgroundView {
    ...
    if(self.defaultMaskType == SVProgressHUDMaskTypeGradient){
        if(!_backgroundRadialGradientLayer){
            _backgroundRadialGradientLayer = [HFSVRadialGradientLayer layer];
        }
