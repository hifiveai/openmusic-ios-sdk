...
@interface LPSegmentViewController() <UIScrollViewDelegate, UIGestureRecognizerDelegate>
@property (nonatomic, strong) LPCategoryView *categoryView;
...
#pragma mark - Getters
- (LPCategoryView *)categoryView {
    if (!_categoryView) {
        _categoryView = [[LPCategoryView alloc] init];
    }
